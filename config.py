...
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1003013283810")) #Your db channel Id
OWNER = os.environ.get("OWNER", "xFlexyy") # Owner username without @
OWNER_ID = int(os.environ.get("OWNER_ID", "7125448912")) # Owner id
#--------------------------------------------
