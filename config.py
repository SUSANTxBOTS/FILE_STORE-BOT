...
#--------------------------------------------
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "8467658426:AAFwPQwyApCpL30sWLmpcBOE3kTrrnwamyI")
APP_ID = int(os.environ.get("APP_ID", "21134445")) #Your API ID from my.telegram.org
API_HASH = os.environ.get("API_HASH", "231c18ea7273824491d6bf05425ab74e") #Your API Hash from my.telegram.org
#--------------------------------------------

CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002498722116")) #Your db channel Id
OWNER = os.environ.get("OWNER", "NoOneIsMinee") # Owner username without @
OWNER_ID = int(os.environ.get("OWNER_ID", "8156708830")) # Owner id
#--------------------------------------------
PORT = os.environ.get("PORT", "8001")
#--------------------------------------------
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://susantpc1232_db_user:MsGk2PTlLnzhh2VQ@cluster0.uqxwqld.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DB_NAME = os.environ.get("DATABASE_NAME", "Cluooodd")
#--------------------------------------------
...
"""
#--------------------------------------------
CUSTOM_CAPTION = os.environ.get("CUSTOM_CAPTION", "<b>• ʙʏ @OrbinexXbotz</b>") #set your Custom Caption here, Keep None for Disable Custom Caption
